...
export const messages = {
  fr: {
    ...
    snack: "En-cas",
    addFood: "+ Aliment",
    savedMealsOpen: "Repas",
    savedMeals: "Repas sauvés",
    saveThisMeal: "Sauver ce repas",
    savedMealName: "Nom du repas",
    noSavedMeals:
      "Aucun repas sauvé. Compose un repas une fois, puis sauve-le ici.",
    applyMeal: "Appliquer",
    mealTemplateSaved: "Repas sauvé ✓",
    cannotSaveEmptyMeal: "Ajoute des aliments avant de sauver ce repas.",
    deleteSavedMealConfirm:
      "Supprimer « {name} » des repas sauvés ? Les jours déjà loggés ne changent pas.",
    savedMealMeta: "{n} aliments · {kcal} kcal",
    delete: "Suppr.",
    ...
    settings: "Réglages",
    profile: "Profil",
    settingsIntro: "Mifflin–St Jeor + kcal, protéines, et quotas Carbo / Lip.",
    sex: "Sexe",
    male: "Homme",
    female: "Femme",
    age: "Âge",
    ...
    fatPerDay: "Lipides (g / jour)",
    carbFatHint:
      "Suggestion à partir de tes kcal et protéines — tu peux changer.",
    carbTarget: "Cible glucides : {n} g / jour",
    fatTarget: "Cible lipides : {n} g / jour",
    useSuggested: "Suggestion",
    save: "Enregistrer",
    saved: "Enregistré ✓",
  ...
  en: {
    ...
    snack: "Snack",
    addFood: "+ Food",
    savedMealsOpen: "Meals",
    savedMeals: "Saved meals",
    saveThisMeal: "Save this meal",
    savedMealName: "Meal name",
    noSavedMeals: "No saved meals yet. Log a meal once, then save it here.",
    applyMeal: "Apply",
    mealTemplateSaved: "Meal saved ✓",
    cannotSaveEmptyMeal: "Add foods before saving this meal.",
    deleteSavedMealConfirm:
      "Remove “{name}” from saved meals? Days already logged stay as they are.",
    savedMealMeta: "{n} foods · {kcal} kcal",
    delete: "Delete",
    noFood: "No foods yet",
    addSnack: "+ Snack",
    ...
    settings: "Settings",
    profile: "Profile",
    settingsIntro: "Mifflin–St Jeor + calorie goal, protein, and carb / fat quotas.",
    sex: "Sex",
    male: "Male",
    female: "Female",
    age: "Age",
    ...
    fatPerDay: "Fat (g / day)",
    carbFatHint: "Suggested from your calories and protein — you can change them.",
    carbTarget: "Carb target: {n} g / day",
    fatTarget: "Fat target: {n} g / day",
    useSuggested: "Suggested",
    save: "Save",
    saved: "Saved ✓",
