...
export const messages = {
  fr: {
    ...
    close: "Fermer",
    tabOff: "Open Food Facts",
    tabManual: "Manuel",
    tabSaved: "Sauvegardés",
    searchLabel: "Recherche (FR)",
    ...
    stopScan: "Arrêter",
    scanHint:
      "Vise le code. Si la caméra rame, prends une photo ou tape le numéro.",
    scanPhoto: "Photo du code",
    scanTypeLabel: "Ou tape le code",
    scanTypePlaceholder: "ex. 3017620422003",
    lookUp: "Chercher",
    barcodeNotFound: "Produit introuvable dans Open Food Facts",
    barcodeInvalid: "Code-barres invalide",
    barcodePhotoFailed: "Code illisible sur la photo — réessaie ou tape-le.",
    cameraDenied: "Caméra refusée — photo ou saisie du code.",
  ...
  en: {
    ...
    stopScan: "Stop",
    scanHint:
      "Point at the barcode. If the camera struggles, take a photo or type the number.",
    scanPhoto: "Photo of the code",
    scanTypeLabel: "Or type the code",
    scanTypePlaceholder: "e.g. 3017620422003",
    lookUp: "Look up",
    barcodeNotFound: "Product not found in Open Food Facts",
    barcodeInvalid: "Invalid barcode",
    barcodePhotoFailed: "Couldn’t read the photo — retry or type the code.",
    cameraDenied: "Camera denied — use a photo or type the code.",
